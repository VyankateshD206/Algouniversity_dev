    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-950 to-black text-white flex items-center justify-center px-6 py-16">
      ...
      >
        ...
        <section className="space-y-6 text-gray-300 text-lg leading-relaxed">
          ...
          >
            <span className="font-bold text-white">ByteForge</span> is a{" "}
          ...
          >
            ...
            developer community, ByteForge helps you become{" "}
        ...
        >
          <a
            href="https://linktr.ee/Ayush_Gupta_3900"
            target="_blank"
          ...
          >
            ...
            <p className="text-sm text-gray-400">
              Creator & Developer of ByteForge
            </p>
        ...
        >
          ...
          <span className="text-white font-medium">ByteForge</span> — All Rights
          Reserved
        </motion.footer>
      </motion.div>
    </main>
